...
<head>
    ...
    <title>支持環保 自備飲料杯 7/1起 單杯省$5元</title>
    ...
    <script>
        ...
        $(() => {
            $("#newtitle").html("支持環保 自備飲料杯 7/1起 單杯省$5元")
            newtext()
        })
    </script>
    <style>
        ...
        <div class="container mt-1 text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="./image/news/03/03.jpg" class="mt-5 w-75 card-img-bottom" alt="...">
                </div>
            </div>
            <div class="mt-5 p-5">
