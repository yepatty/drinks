...
<head>
    ...
    <title>蜜蜂工坊 x 迷客夏聯名飲品-蜜香紅茶拿鐵 在7-11也喝得到！</title>
    ...
    <script>
        ...
        $(() => {
            $("#newtitle").html("蜜蜂工坊 x 迷客夏聯名飲品-蜜香紅茶拿鐵 在7-11也喝得到！")
            newtext()
        })
    </script>
    <style>
        ...
        <div class="container mt-1 text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <img src="./image/news/04/04.jpg" class="mt-5 w-75 card-img-bottom" alt="...">
                </div>
            </div>
            <div class="mt-5 p-5">
