...
<head>
    ...
    <script>
        ...
        $(() => {
            $("#newtitle").html("2023迷客夏春節期間門市營業資訊")
            newtext()
        })
        ...
        <div class="container mt-1 text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="text"></div>
                    <img src="./image/news/08/08.jpg" class="mt-5 w-75 card-img-bottom" alt="...">
                </div>
            </div>
            <div class="mt-5 p-5">
