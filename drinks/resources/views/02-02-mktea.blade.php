...
<body>
    <div class="">
        ...
        <div class="container-fluid mt-1 text-center">
            <h1 class="display-5 m-4 p-1 text-success">
                <span style="background-color:#c6dfc8;">
                    牧場鮮奶茶 Fresh Milk Tea
                </span>
            </h1>
                ...
                @foreach ($milkteas as $mktea)
                    <div class="col">
                        <div class="card border-success h-100">
                            <div class="">
                                <img src="{{ $mktea->imgpath }}" class="card-img-top w-25" alt="...">
                            </div>
                            <div class="card-body">
                                <h2 class="card-title">{{ $mktea->pname }}</h2>
                                <p class="card-text  text-start">{{ $mktea->ptxt }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="mt-5 p-5">
                ...
                href="http://localhost/drinks/public/products">
                    回列表頁
                </a>
            </div>
        </div>
