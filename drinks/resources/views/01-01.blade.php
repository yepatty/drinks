...
<head>
    ...
    <title>賀！迷客夏榮獲《2023 A.A 全球純粹風味評鑑》三星獎</title>
    ...
    <script>      
        ...
        $(() => {
            $("#newtitle").html("賀！迷客夏榮獲《2023 A.A 全球純粹風味評鑑》三星獎")
            newtext()
        })
        ...
        <div class="container mt-1 text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="text" class="text-start">
                    </div>
                    <img src="./image/news/01/01.jpg" class="img-fluid mt-5 card-img-bottom" alt="...">
                </div>
            </div>
