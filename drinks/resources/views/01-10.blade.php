        ...
        <div class="container mt-1 text-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="text" class="text-start"></div>
                    <img src="./image/news/10/10.jpg" class="mt-5 w-75 card-img-bottom" alt="...">
                </div>
            </div>
            <div class="mt-5 p-5">
